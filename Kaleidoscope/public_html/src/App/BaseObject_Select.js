...
/*global ClassExample, matrix, BodyWithArms  */
/* find out more about jslint: http://www.jslint.com/help.html */

"use strict";  // Operate in Strict mode such that variables must be declared before used!

BodyWithArms.prototype.selectBase = function (wcPos, manipulator) {
...
BodyWithArms.prototype.selectArmBase = function (wcPos, manipulator) {
    var baseMat = this.getXform().getXform();
    return this.mArmBase.selected(wcPos, baseMat, manipulator);
};

BodyWithArms.prototype.selectArmTipLeft = function (wcPos, manipulator) {
    var baseMat = this.getXform().getXform();
    return this.mArmTipLeft.selected(wcPos, baseMat, manipulator);
};

BodyWithArms.prototype.selectArmTipRight = function (wcPos, manipulator) {
    var baseMat = this.getXform().getXform();
